...
# add_input_file [list [concat {  } { mem.vhd lab3.vhd }] ]
foreach file [concat {  } { mem.vhd lab3.vhd }] {
  add_input_file $file
}  

compile

auto_write uw_tmp/lab3_gate.vhd
...
auto_write uw_tmp/lab3_logic.vhd
...
auto_write uw_tmp/lab3_logic.v
