...
xsys("quartus_sh -t Y://lib/pins-NULL.tcl lab3")
...
xsys( "quartus_sta -t Y://skel/timing-quartus.tcl lab3" )
...
my_cp( "uw_tmp/lab3.timing.rpt", "RPT/timing_chip.rpt", error_level=1 )
